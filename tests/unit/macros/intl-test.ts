...
import { setupIntl, TestContext as BaseTextContext } from 'pilas-bloques-ember-intl/test-support';
import { intl } from 'pilas-bloques-ember-intl';
import { __intlInjectionName } from 'pilas-bloques-ember-intl/macros/intl';
